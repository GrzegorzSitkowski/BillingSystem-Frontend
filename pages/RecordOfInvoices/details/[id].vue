    ...
    <VCard>
        <v-toolbar color="transparent">
            <template v-slot:prepend>
                <v-btn icon="mdi-chevron-left" to="/RecordOfInvoices"></v-btn>
            </template>
                ...
                <v-row>
                    ...
                    <v-col cols="12" sm="6">
                        <VCardText>                         
                            ...
                            <VTextField v-model="viewModel.statusInvoice" variant="outlined" label="Status Invoice" filled readonly></VTextField>
                            <VTextField v-model="viewModel.statusPayment" variant="outlined" label="Status Payment" filled readonly></VTextField>
                        </VCardText>
                    </v-col>
                </v-row>
            </v-container>
