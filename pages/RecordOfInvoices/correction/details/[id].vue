    ...
    <VCard>
        <v-toolbar color="transparent">
            <template v-slot:prepend>
                <v-btn icon="mdi-chevron-left" to="/RecordOfInvoices/Correction"></v-btn>
            </template>
                ...
                <v-row>
                    <v-col cols="12" sm="6">
                        <VCardText>                         
                            ...
                            <VTextField v-model="viewModel.reason" variant="outlined" label="Reason" filled readonly></VTextField>
                            <VTextField v-model="viewModel.describe" variant="outlined" label="Describe" filled readonly></VTextField>
                            <VTextField v-model="viewModel.invoiceId" variant="outlined" label="InvoiceId" filled readonly></VTextField>
                        </VCardText>
                    </v-col>
                    <v-col cols="12" sm="6">
                        <VCardText>                         
                            ...
                            <VTextField v-model="viewModel.createdBy" variant="outlined" label="CreatedBy" filled readonly></VTextField>
                        </VCardText>
                    </v-col>
                </v-row>
            </v-container>
...
const get = () => {
    useWebApiFetch(`/Corrections/GetCorrection`, {
        method: 'GET',
